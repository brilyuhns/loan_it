...
class SharesControllerTest < ActionController::TestCase
  ...
  test "should create share" do
    assert_difference('Share.count') do
      post :create, share: { group_id: @share.group_id, resource_id: @share.resource_id, user_id: @share.user_id }
    end
  ...
  test "should update share" do
    put :update, id: @share, share: { group_id: @share.group_id, resource_id: @share.resource_id, user_id: @share.user_id }
    assert_redirected_to share_path(assigns(:share))
  end
